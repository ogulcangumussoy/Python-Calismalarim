import sys
import os
from PyQt5.QtWidgets import QApplication,QWidget,QHBoxLayout,QVBoxLayout,qApp,QPushButton,QMainWindow,QAction,QTextEdit,QLabel,QFileDialog
import PyQt5.QtGui
class Notepad(QWidget):
    ...
    def dosya_ac(self): #self ile pencereyi kastettik
...
class Menu(QMainWindow):
    def __init__(self):
        super().__init__()
        self.pencere=Notepad() #pencere oluşturduk menünün içine ekliyeceğiz.
    ...
    def menuleri_olustur(self):
        ...
        temizle=QAction("Yazıyı Temizle",self)
    ...
    def response(self,action):
        ...
        elif action.text() == "Yazıyı Temizle":
            self.pencere.yaziyi_temizle()
        elif action.text()== "Çıkış":
            qApp.quit() #çıkış yaptık.
